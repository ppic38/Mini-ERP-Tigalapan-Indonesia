...
export default function ProduksiMaterialStatusPage() {
  ...
  const columns: ColumnDef<(typeof rows)[number]>[] = [
    ...
    { key: "warna", label: "Warna / Lengan", default: true, render: (r) => `${r.po.warna} · ${r.po.lengan}` },
  ...
  return (
    ...
    >
      <DataTable
        title="PO Material"
        subtitle="Breakdown roll per tahap, dari data Good Receive & cutting yang sudah tercatat"
        columns={columns}
        rows={rows}
        keyOf={(r) => r.po.id}
