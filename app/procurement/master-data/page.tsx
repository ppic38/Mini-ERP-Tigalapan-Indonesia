...
import { MaterialSupplierPanel } from "@/components/procurement/material-supplier-panel";
...
//
// Update 2026-09-16: tab "Supplier Kain" BARU (migration 0042, MaterialSupplierPanel) -- BEDA dari
// tab "Supplier" lama di atas (yang datanya dummy & sudah dilepas) -- ini daftar supplier ASLI yang
// dipakai live sebagai dropdown di Harga Kain & Harga Kain PKS, bukan sekadar referensi pasif.
type Tab = "maklon" | "kain" | "kainPks" | "rib" | "ekspedisi" | "kerahManset" | "supplierKain";
    ...
    <AppShell role="procurement" activeHref="/procurement/master-data" breadcrumb={["Dashboard", "Master Data"]} title="Master Data">
      <Tabs
        items={[
          ...
          { key: "supplierKain", label: "Supplier Kain" },
      ...
      {tab === "supplierKain" && <MaterialSupplierPanel />}
